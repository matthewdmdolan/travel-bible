...
spreadsheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1SJ8jgQQNiO8YLmvWaz8DhXm1MoxKLl1Y5OtYF8Xpib0/edit#gid=0')
...
history_df .to_sql('travel_plans_info', conn, if_exists='replace', index=False)
conn.close()
